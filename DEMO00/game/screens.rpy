...
screen main_menu():
    ...
    add ParallaxDisplayable("images/test/paraA_3.png", depth=60)          #"back.png"
    add ParallaxDisplayable("images/test/paraA_2.png", depth=35)          #"mid.png"
    add ParallaxDisplayable("images/test/paraA_1.png", depth=20)          #"face.png"
