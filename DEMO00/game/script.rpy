...
label after_intro:
    ...
    p "走了一天，终于可以躺下了。"
    p "不过身体虽然累了，但感觉大脑好像还没有困意。毕竟白天发生了那么多事情。"
...
label park_route:
    ...
    "【转场：街道、店面之类的】"
    p "啊——公园，好久没来这里了。【可以放过去公园的样子】。"
    p "现在这个时候，还能隐约听到一点蝉鸣。露在外面的皮肤还能感受到丝丝凉风，光是坐在长椅上就很放松了。"
...
label look_away:
    ...
    "？？？：“虽然3年前再版过一次，不过果然原版的质感是最佳的。”"

    p "......是吗？我确实不太了解呢。只知道是很久以前买的了。"

    "现在周围的光线已经逐渐暗了下来。她竟然还能看得出这么多细节。真是佩服她的眼力。"
